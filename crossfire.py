...
"""
*Cr*appy *O*pen *S*ource *S*oftware: *F*eedreader *I*n *R*esponse to *E*van
...
if options.Feed is None:
    ...
    print ''
    print sys.argv[0], '-f http://identi.ca/api/statuses/public_timeline.atom'
    print ''
    sys.exit(1)
...
print 'The current time is',time.strftime("%a, %d %b %Y %H:%M:%S +0000",
										  time.localtime())
print 'It took me', time.time() - starttime, 'seconds to do your bidding.'
print 
